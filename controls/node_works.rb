title 'Tests to confirm node6 works as expected'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'node6')

control 'core-plans-node6-works' do
  impact 1.0
  title 'Ensure node6 works as expected'
  desc '
  Verify node6 by ensuring that its
